<?php
	...
	$config['sqlPassword'] = '592860';

	// The database name to connect to. (This is usually same as username).
	$config['sqlDatabase'] = 'rook';
	...
	*/
	...
	$config['house'] = array(
		'house_file' => '/home/rook/data/world/rook-house.xml',
	...
	$config['gameserver'] = array(
		'ip' => '127.0.0.1',
		'port' => 7172,
		'name' => 'RookWar' // Must be identical to config.lua (OT config file) server name.
	);
	...
	*/
		...
		1 => array(
			'type' => 1,
			'itemid' => 2501, // item to get in-game
			'count' => 1, // Stack number (5x itemid)
			'description' => "donate knight helmet (Arm:20, axe fighting +5).", // Description shown on website
		...
		2 => array(
			...
			'itemid' => 2503,
			'count' => 1,
			'description' => "donate knight armor (Arm:20, axe fighting +5).",
			'points' => 100,
		),
		3 => array(
			'type' => 1,
			'itemid' => 2504,
			'count' => 1,
			'description' => "donate knight legs (Arm:20, axe fighting +5).",
			'points' => 100,
		),
		4 => array(
			'type' => 1,
			'itemid' => 2524,
			'count' => 1,
			'description' => "donate knight shield (Def:30, axe fighting +5).",
			'points' => 100,
		),
		5 => array(
			'type' => 1,
			'itemid' => 2662,
			'count' => 1,
			'description' => "donate mage hat (Arm:20, magic level +5).",
			'points' => 100,
		),
		6 => array(
			'type' => 1,
			'itemid' => 8866,
			'count' => 1,
			'description' => "donate mage armor (Arm:20, magic level +5).",
			'points' => 100,
		),
		7 => array(
			'type' => 1,
			'itemid' => 7730,
			'count' => 1,
			'description' => "donate mage legs (Arm:20, magic level +5).",
			'points' => 100,
		),
		8 => array(
			'type' => 1,
			'itemid' => 2542,
			'count' => 1,
			'description' => "donate mage shield (Def:30, magic level +5).",
			'points' => 100,
		),
		9 => array(
			'type' => 1,
			'itemid' => 2506,
			'count' => 1,
			'description' => "donate paladin helmet (Arm:20, distance fighting +5).",
			'points' => 100,
		),
		10 => array(
			'type' => 1,
			'itemid' => 2492,
			'count' => 1,
			'description' => "donate paladin armor (Arm:20, distance fighting +5).",
			'points' => 100,
		),
		11 => array(
			'type' => 1,
			'itemid' => 2469,
			'count' => 1,
			'description' => "donate paladin legs (Arm:20, distance fighting +5).",
			'points' => 100,
		),
		12 => array(
			'type' => 1,
			'itemid' => 8909,
			'count' => 1,
			'description' => "donate paladin shield (Def:30).",
			'points' => 100,
		),
		13 => array(
			'type' => 1,
			'itemid' => 9932,
			'count' => 1,
			'description' => "donate boots (Arm:5, speed +20, faster regeneration). +160 Mana/Vida cada 2 segundos",
			'points' => 100,
		),
		14 => array(
			'type' => 1,
			'itemid' => 5907,
			'count' => 1,
			'description' => "donate paladin slingshot (Atk:100).",
			'points' => 50,
		),
		15 => array(
			'type' => 1,
			'itemid' => 8293,
			'count' => 1,
			'description' => "donate knight axe (Atk:110).",
			'points' => 50,
		),
		16 => array(
			'type' => 1,
			'itemid' => 8927,
			'count' => 1,
			'description' => "donate mage rod (Atk:90-100).",
			'points' => 50,
		),
		17 => array(
			'type' => 3,
		...
		19 => array(
			'type' => 5,
			'itemid' => 367, // Outfit ID
			'count' => 3, // Addon 0 = none, 1 = first, 2 = second, 3 = both
			'description' => "Wayfarer male/female with both addons",
			'points' => 100,
		),
		20 => array(
			'type' => 5,
			'itemid' => 335, // Mount ID
			'count' => 3,
			'description' => "Warmaster male/female with both addons",
			'points' => 100,
		),
	);
